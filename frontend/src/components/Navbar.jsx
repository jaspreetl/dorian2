...
const Navbar = () => {
        ...
        <div className='flex items-center justify-between p-5 font-medium'>
            ...
            <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
                <NavLink to='/' className='flex flex-col items-center gap-1'>
                    <p>home</p>
                    {/* hr line underlines navbar page*/}
  ...
  {token && profileDropdownVisible && (
    <div className="absolute right-0 pt-4 z-10">
      <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 shadow-md rounded-md'>
        ...
        <p onClick={logout} className="cursor-pointer hover:text-black">log out</p>
                ...
                {/* if page is small, show menu icon instead of all menu items */}
